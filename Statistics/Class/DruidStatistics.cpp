...
DruidStatistics::DruidStatistics(SimSettings *settings) :
    ClassStatistics(settings)
{

}

int DruidStatistics::getNumStatisticsRows() const {
...
QVariantList DruidStatistics::getTableInfo(const int index) const {
...
QVariantList DruidStatistics::getChartInfo(const int index) const {
...
QString DruidStatistics::getEntryIcon(const int) const {
    return "";
}
