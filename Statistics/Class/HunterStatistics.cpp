...
HunterStatistics::HunterStatistics(QObject *parent) :
    ClassStatistics(parent)
{

}

void HunterStatistics::update_statistics() {
    // TODO: Find all valid entries
}

int HunterStatistics::getNumStatisticsRows() const {
...
QVariantList HunterStatistics::getTableInfo(const int index) const {
...
QVariantList HunterStatistics::getChartInfo(const int index) const {
...
QString HunterStatistics::getEntryIcon(const int) const {
