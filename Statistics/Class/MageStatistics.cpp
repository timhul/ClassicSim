...
MageStatistics::MageStatistics(SimSettings *settings) :
    ClassStatistics(settings)
{

}

int MageStatistics::getNumStatisticsRows() const {
...
QVariantList MageStatistics::getTableInfo(const int index) const {
...
QVariantList MageStatistics::getChartInfo(const int index) const {
...
QString MageStatistics::getEntryIcon(const int) const {
    return "";
}
