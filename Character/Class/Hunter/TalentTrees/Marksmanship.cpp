...
{
    QMap<QString, Talent*> tier1 {{"1ML", new Talent(hunter, this, "Improved Concussive Shot", "1ML", "Assets/spell/Spell_frost_stun.png", 5, "Gives your Concussive Shot a %1% chance to stun the target for 3 sec.", QVector<QPair<int, int>>{{4, 4}})},
                                  {"1MR", get_efficiency()}};
    add_talents(tier1);
    ...
    QMap<QString, Talent*> tier3 {{"3LL", get_aimed_shot()},
                                  ...
                                  {"3RR", new Talent(hunter, this, "Hawk Eye", "3RR", "Assets/ability/Ability_townwatch.png", 3, "Increases the range of your ranged weapons by %1 yards.", QVector<QPair<int, int>>{{2, 2}})}};
    add_talents(tier3);
    ...
    QMap<QString, Talent*> tier5 {{"5LL", new Talent(hunter, this, "Scatter Shot", "5LL", "Assets/ability/Ability_golemstormbolt.png", 1, "A short-range shot that deals 50% weapon damage and disorients the target for 4 sec. Any damage caused will remove the effect. Turns off your attack when used.", QVector<QPair<int, int>>())},
                                  {"5ML", new Talent(hunter, this, "Barrage", "5ML", "Assets/ability/Ability_upgrademoonglaive.png", 3, "Increases the damage done by your Multi-Shot and Volley spells by %1%.", QVector<QPair<int, int>>{{5, 5}})},
