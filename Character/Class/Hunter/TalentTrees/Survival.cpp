    ...
    TalentTree("Survival", "Assets/hunter/hunter_survival.jpg")
{
    ...
    QMap<QString, Talent*> tier2 {{"2LL", new Talent(pchar, this, "Entrapment", "2LL", "Assets/spell/Spell_nature_stranglevines.png", 5, "Gives your Immolation Trap, Frost Trap, and Explosive Trap a %1% chance to entrap the target, preventing them from moving for 5 sec.", QVector<QPair<int, int>>{{5, 5}})},
                                  {"2ML", new Talent(pchar, this, "Savage Strikes", "2ML", "Assets/ability/Ability_racial_bloodrage.png", 2, "Increases the critical strike chance of Raptor Strike and Mongoose Bite by %1%.", QVector<QPair<int, int>>{{10, 10}})},
                                  {"2MR", new Talent(pchar, this, "Improved Wing Clip", "2MR", "Assets/ability/Ability_rogue_trip.png", 5, "Gives your Wing Clip ability a %1% chance to immobilize the target for 5 sec.", QVector<QPair<int, int>>{{4, 4}})}};
    add_talents(tier2);

    QMap<QString, Talent*> tier3 {{"3LL", new Talent(pchar, this, "Clever Traps", "3LL", "Assets/spell/Spell_nature_timestop.png", 2, "Increases the duration of Freezing and Frost trap effects by %1% and the damage of Immolation and Explosive trap effects by %2%.", QVector<QPair<int, int>>{{15, 15}, {15, 15}})},
                                  {"3ML", new Talent(pchar, this, "Survivalist", "3ML", "Assets/spell/Spell_shadow_twilight.png", 5, "Increases total health by %1%.", QVector<QPair<int, int>>{{2, 2}})},
                                  {"3MR", new Talent(pchar, this, "Deterrence", "3MR", "Assets/ability/Ability_whirlwind.png", 1, "When activated, increases your Dodge and Parry chance by 25% for 10 sec.", QVector<QPair<int, int>>())}};
    add_talents(tier3);
