    ...
    TalentTree("Fury", "Assets/warrior/warrior_fury.jpg",  parent)
{
    ...
    QMap<QString, Talent*> tier3 {{"3LL", new ImprovedCleave(pchar, this)},
                                  {"3ML", new GenericTalent(pchar, this, "Piercing Howl", "3ML", base_url + "tier3/Spell_shadow_deathscream.png", 1, "Causes all enemies near the warrior to be dazed, reducing movement speed by 50% for 6 sec.", 0, 0, false)},
                                  {"3MR", new GenericTalent(pchar, this, "Blood Craze", "3MR", base_url + "tier3/Spell_shadow_summonimp.png", 3, "Regenerates %1% of your total Health over 6 sec after being the victim of a critical strike.", 1, 1, true)},
    ...
    QMap<QString, Talent*> tier4 {{"4LL", new DualWieldSpecialization(pchar, this)},
                                  ...
                                  {"4MR", new GenericTalent(pchar, this, "Enrage", "4MR", base_url + "tier4/Spell_shadow_unholyfrenzy.png", 5, "Gives you a %1% melee damage bonus for 12 sec up to a maximum of 12 swings after being the victim of a critical strike.", 5, 5, true)}};
    add_talents(tier4);

    QMap<QString, Talent*> tier5 {{"5LL", new ImprovedSlam(pchar, this)},
                                  {"5ML", new DeathWish(pchar, this)},
                                  {"5RR", new GenericTalent(pchar, this, "Improved Intercept", "5RR", base_url + "tier5/Ability_rogue_sprint.png", 2, "Reduces the cooldown of your Intercept ability by %1 sec.", 5, 5, true)}};
    add_talents(tier5);
