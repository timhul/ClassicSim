    ...
    TalentTree("Fury", "Assets/warrior/warrior_fury.jpg")
{
    ...
    QMap<QString, Talent*> tier3 {{"3LL", new ImprovedCleave(pchar, this)},
                                  ...
                                  {"3MR", new GenericTalent(pchar, this, "Blood Craze", "3MR", base_url + "tier3/Spell_shadow_summonimp.png", 3, "Regenerates %1% of your total Health over 6 sec after being the victim of a critical strike.", QVector<QPair<int, int>>{QPair<int, int>(1, 1)})},
    ...
    QMap<QString, Talent*> tier4 {{"4LL", new DualWieldSpecialization(pchar, this)},
                                  ...
                                  {"4MR", new GenericTalent(pchar, this, "Enrage", "4MR", base_url + "tier4/Spell_shadow_unholyfrenzy.png", 5, "Gives you a %1% melee damage bonus for 12 sec up to a maximum of 12 swings after being the victim of a critical strike.", QVector<QPair<int, int>>{QPair<int, int>(5, 5)})}};
    add_talents(tier4);
