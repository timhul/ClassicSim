    ...
    spells(dynamic_cast<WarriorSpells*>(pchar->get_spells()))
{
    QMap<QString, Talent*> tier1 {{"1LL", get_improved_heroic_strike()},
                                  {"1ML", new Talent(pchar, this, "Deflection", "1ML", base_url + "ability/Ability_parry.png", 5, "Increase your Parry chance by %1%.", QVector<QPair<int, int>>{{1, 1}})},
                                  {"1MR", get_improved_rend()}};
    add_talents(tier1);

    QMap<QString, Talent*> tier2 {{"2LL", new Talent(pchar, this, "Improved Charge", "2LL", base_url + "ability/Ability_warrior_charge.png", 2, "Increases the amount of rage generated by your Charge ability by %1.", QVector<QPair<int, int>>{{3, 2}})},
                                  {"2ML", new TacticalMastery(pchar, this)},
                                  {"2RR", new Talent(pchar, this, "Improved Thunder Clap", "2RR", base_url + "spell/Spell_nature_thunderclap.png", 3, "Reduces the cost of your Thunder Clap ability by %1 rage.", QVector<QPair<int, int>>{{1, 1}})}};
    add_talents(tier2);
    ...
    QMap<QString, Talent*> tier5 {{"5LL", new AxeSpecialization(pchar, this)},
                                  {"5ML", new Talent(pchar, this, "Sweeping Strikes", "5ML", "Assets/ability/Ability_rogue_slicedice.png", 1, "Your next 5 melee attacks strike an additional nearby opponent.", QVector<QPair<int, int>>{})},
                                  {"5MR", new Talent(pchar, this, "Mace Specialization", "5MR", "Assets/items/Inv_mace_01.png", 5, "Gives you a %1% chance to stun your target for 3 sec with a Mace.", QVector<QPair<int, int>>{{1, 1}})},
                                  {"5RR", new SwordSpecializationTalent(pchar, this)}};
    add_talents(tier5);

    QMap<QString, Talent*> tier6 {{"6LL", new PolearmSpecialization(pchar, this)},
                                  {"6MR", new Talent(pchar, this, "Improved Hamstring", "6MR", base_url + "ability/Ability_shockwave.png", 3, "Gives your Hamstring ability a %1% chance to immobilize the target for 5 sec.", QVector<QPair<int, int>>{{5, 5}})}};
    add_talents(tier6);
