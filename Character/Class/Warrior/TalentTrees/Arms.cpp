    ...
    TalentTree("Arms", "Assets/warrior/warrior_arms.jpg", parent)
{
    ...
    QMap<QString, Talent*> tier1 {{"1LL", new ImprovedHeroicStrike(pchar)},
    ...
    QMap<QString, Talent*> tier3 {{"3LL", new ImprovedOverpower(pchar)},
    ...
    QMap<QString, Talent*> tier4 {{"4ML", new TwoHandedWeaponSpecialization(pchar)},
                                  {"4MR", new Impale(pchar)}};
    add_talents(tier4);

    QMap<QString, Talent*> tier5 {{"5LL", new AxeSpecialization(pchar)},
