...
ImprovedSlam::ImprovedSlam(Character *pchar) :
    Talent(pchar, "Improved Slam", "5LL", "Assets/warrior/fury/tier5/Ability_warrior_decisivestrike.png", 5)
{
...
QString ImprovedSlam::get_requirement_string() const {
