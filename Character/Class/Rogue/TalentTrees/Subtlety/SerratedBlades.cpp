...
{
    QString base_str = "Causes your attacks to ignore %1 of your target's Armor and increases the damage dealt by your Rupture ability by %2%. The amount of Armor reduced increases with your level.";
    initialize_rank_descriptions(rank_descriptions, base_str, max_points, QVector<QPair<int, int>>{{100, 100}, {10, 10}});
}
