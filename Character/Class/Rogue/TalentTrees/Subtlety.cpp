    ...
    TalentTree("Subtlety", "Assets/rogue/rogue_subtlety.jpg")
{
    ...
    QMap<QString, Talent*> tier2 {{"2LL", new GenericTalent(pchar, this, "Sleight of Hand", "2LL", "Assets/ability/Ability_rogue_feint.png", 2, "Reduces the chance you are critically hit by melee and ranged attacks by %1% and increases the threat reduction of your Feint ability by %2%.", QVector<QPair<int, int>>{{1, 1}, {10, 10}})},
                                  {"2ML", new GenericTalent(pchar, this, "Elusiveness", "2ML", "Assets/spell/Spell_magic_lesserinvisibilty.png", 2, "Reduces the cooldown of your Vanish and Blind abilities by %1 sec.", QVector<QPair<int, int>>{{45, 45}})},
                                  {"2MR", new GenericTalent(pchar, this, "Camouflage", "2MR","Assets/ability/Ability_stealth.png", 5, "Increases your speed while stealthed by %1% and reduces the cooldown of your Stealth ability by %2 sec.", QVector<QPair<int, int>>{{3, 3}, {1, 1}})}};
    add_talents(tier2);

    QMap<QString, Talent*> tier3 {{"3LL", new GenericTalent(pchar, this, "Initiative", "3LL", "Assets/spell/Spell_shadow_fumble.png", 3, "Gives you a %1% chance to add an additional combo point to your target when using your Ambush, Garrote, or Cheap Shot ability.", QVector<QPair<int, int>>{{25, 25}})},
                                  ...
                                  {"3MR", new GenericTalent(pchar, this, "Improved Ambush", "3MR", "Assets/ability/Ability_rogue_ambush.png", 3, "Increases the critical strike chance of your Ambush ability by %1%.", QVector<QPair<int, int>>{{15, 15}})}};
    add_talents(tier3);

    QMap<QString, Talent*> tier4 {{"4LL", new GenericTalent(pchar, this, "Setup", "4LL", "Assets/spell/Spell_nature_mirrorimage.png", 3, "Gives you a %1% chance to add a combo point to your target after dodging their attack or fully resisting one of their spells.", QVector<QPair<int, int>>{{15, 15}})},
                                  {"4ML", new GenericTalent(pchar, this, "Improved Sap", "4ML", "Assets/ability/Ability_sap.png", 3, "Gives you a %1% chance to return to stealth mode after using your Sap ability.", QVector<QPair<int, int>>{{30, 30}})},
