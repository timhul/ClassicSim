    ...
    spells(dynamic_cast<PaladinSpells*>(paladin->get_spells()))
{
    ...
    QMap<QString, Talent*> tier3 {{"3LL", new Talent(paladin, this, "Blessing of Kings", "3LL", "Assets/spell/Spell_magic_magearmor.png", 1, "Places a Blessing on the friendly target, increasing total stats by 10% for 5 min. Players may only have one Blessing on them per Paladin at any one time.", QVector<QPair<unsigned, unsigned>>())},
                                  {"3ML", new Talent(paladin, this, "Improved Righteous Fury", "3ML", "Assets/spell/Spell_holy_sealoffury.png", 3, "Increases the amount of threat generated by your Righteous Fury spell by %1%.", QVector<QPair<unsigned, unsigned>>{{16, 17}})},
                                  {"3MR", new Talent(paladin, this, "Shield Specialization", "3MR", "Assets/items/Inv_shield_06.png", 3, "Increases the amount of damage absorbed by your shield by %1%.", QVector<QPair<unsigned, unsigned>>{{10, 10}})},
                                  {"3RR", new Talent(paladin, this, "Anticipation", "3RR", "Assets/spell/Spell_nature_mirrorimage.png", 5, "Increases your Defense skill by %1.", QVector<QPair<unsigned, unsigned>>{{2, 2}})}};
    add_talents(tier3);

    QMap<QString, Talent*> tier4 {{"4ML", new Talent(paladin, this, "Improved Hammer of Justice", "4ML", "Assets/spell/Spell_holy_sealofmight.png", 3, "Decreases the cooldown of your Hammer of Justice spell by %1 sec.", QVector<QPair<unsigned, unsigned>>{{5, 5}})},
                                  {"4MR", new Talent(paladin, this, "Improved Concentration Aura", "4MR", "Assets/spell/Spell_holy_mindsooth.png", 3, "Increases the effect of your Concentration Aura by an additional %1% and gives all group members affected by the aura an additional %2% chance to resist Silence and Interrupt effects.", QVector<QPair<unsigned, unsigned>>{{5, 5}, {5, 5}})}};
    add_talents(tier4);

    QMap<QString, Talent*> tier5 {{"5ML", new Talent(paladin, this, "Blessing of Sanctuary", "5ML", "Assets/spell/Spell_nature_lightningshield.png", 1, "Places a Blessing on the friendly target, reducing damage dealt from all sources by up to 10 for 5 min. In addition, when the target blocks a melee attack the attacker will take 14 Holy damage. Players may only have one Blessing on them per Paladin at any one time.", QVector<QPair<unsigned, unsigned>>())},
