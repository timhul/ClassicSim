...
public:
    ExtraAttackInstantProc(Engine* engine, Character* pchar, CombatRoll* roll, const QString& proc_name,
                           const QVector<ProcInfo::Source>& proc_sources, const double proc_rate,
