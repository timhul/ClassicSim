...
Fury::Fury(Warrior* pchar) :
    TalentTree("Fury", "Assets/warrior/warrior_fury.jpg"), warrior(pchar), spells(static_cast<WarriorSpells*>(pchar->get_spells())) {
    ...
    QMap<QString, Talent*> tier2 {
        {"2ML",
         new Talent(pchar, this, "Improved Demoralizing Shout", "2ML", base_url + "ability/Ability_warrior_warcry.png", 5,
                    "Increases the melee attack power reduction of your Demoralizing Shout by %1%.", QVector<QPair<unsigned, unsigned>> {{8, 8}})}};
    add_unbridled_wrath(tier2);
    add_talents(tier2);

    QMap<QString, Talent*> tier3 {{"3LL", new Talent(pchar, this, "Improved Cleave", "3LL", base_url + "ability/Ability_warrior_cleave.png", 3,
                                                     "Increases the bonus damage done by your Cleave ability by %1%.",
                                                     QVector<QPair<unsigned, unsigned>> {{40, 40}})},
                                  {"3ML", new Talent(pchar, this, "Piercing Howl", "3ML", base_url + "spell/Spell_shadow_deathscream.png", 1,
                                                     "Causes all enemies near the warrior to be dazed, reducing movement speed by 50% for 6 sec.",
                                                     QVector<QPair<unsigned, unsigned>>())},
                                  {"3MR", new Talent(pchar, this, "Blood Craze", "3MR", base_url + "spell/Spell_shadow_summonimp.png", 3,
    ...
    QMap<QString, Talent*> tier4 {
        {"4MR", new Talent(pchar, this, "Enrage", "4MR", base_url + "spell/Spell_shadow_unholyfrenzy.png", 5,
                           "Gives you a %1% melee damage bonus for 12 sec up to a maximum of 12 swings after being the victim of a critical strike.",
    ...
    QMap<QString, Talent*> tier5 {
        {"5RR", new Talent(pchar, this, "Improved Intercept", "5RR", base_url + "ability/Ability_rogue_sprint.png", 2,
                           "Reduces the cooldown of your Intercept ability by %1 sec.", QVector<QPair<unsigned, unsigned>> {{5, 5}})}};
...
void Fury::add_booming_voice(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Booming Voice", "1ML", "Assets/spell/Spell_nature_purge.png", 5, rank_descriptions,
...
void Fury::add_unbridled_wrath(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Unbridled Wrath", "2MR", "Assets/spell/Spell_nature_stoneclawtotem.png", 5, rank_descriptions, {}, {},
...
void Fury::add_improved_battle_shout(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Improved Battle Shout", "3RR", "Assets/ability/Ability_warrior_battleshout.png", 5, rank_descriptions,
                                QVector<SpellRankGroup*> {spells->get_spell_rank_group_by_name("Battle Shout")});
...
void Fury::add_dual_wield_specialization(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent::initialize_rank_descriptions(rank_descriptions, base_str, 5, QVector<QPair<unsigned, unsigned>> {{5, 5}});
    Talent* talent = new Talent(warrior, this, "Dual Wield Specialization", "4LL", "Assets/ability/Ability_dualwield.png", 5, rank_descriptions,
...
void Fury::add_improved_execute(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Improved Execute", "4ML", "Assets/items/Inv_sword_48.png", 2, rank_descriptions,
...
void Fury::add_improved_slam(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Improved Slam", "5LL", "Assets/ability/Ability_warrior_decisivestrike.png", 5, rank_descriptions,
...
void Fury::add_death_wish(QMap<QString, Talent*>& talent_tier) {
    QMap<unsigned, QString> rank_descriptions;
    QString base_str = "When activated, increases your physical damage by 20% and makes you immune to Fear effects, but lowers your armor and all "
                       "resistances by 20%. Lasts 30 sec.";
    rank_descriptions.insert(0, base_str);
    rank_descriptions.insert(1, base_str);
    Talent* talent = new Talent(warrior, this, "Death Wish", "5ML", "Assets/spell/Spell_shadow_deathpact.png", 1, rank_descriptions,
...
void Fury::add_improved_berserker_rage(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Improved Berserker Rage", "6LL", "Assets/spell/Spell_nature_ancestralguardian.png", 2,
                                rank_descriptions, QVector<SpellRankGroup*> {spells->get_spell_rank_group_by_name("Berserker Rage")});
...
void Fury::add_flurry_talent(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(warrior, this, "Flurry", "6MR", "Assets/ability/Ability_ghoulfrenzy.png", 5, rank_descriptions, {},
...
void Fury::add_bloodthirst(QMap<QString, Talent*>& talent_tier) {
    QMap<unsigned, QString> rank_descriptions;
    QString base_str = "Instantly attack the target causing damage equal to 45% of your attack power. In addition, the next 5 successful melee "
                       "attacks will restore 10 health. This effect lasts 8 sec.";
    rank_descriptions.insert(0, base_str);
    rank_descriptions.insert(1, base_str);
    Talent* talent = new Talent(warrior, this, "Bloodthirst", "7ML", "Assets/spell/Spell_nature_bloodlust.png", 1, rank_descriptions,
