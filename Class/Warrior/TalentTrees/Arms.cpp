    ...
    spells(static_cast<WarriorSpells*>(pchar->get_spells()))
{
    ...
    QMap<QString, Talent*> tier1 {{"1ML", new Talent(pchar, this, "Deflection", "1ML", base_url + "ability/Ability_parry.png", 5, "Increase your Parry chance by %1%.", QVector<QPair<unsigned, unsigned>>{{1, 1}})}};
