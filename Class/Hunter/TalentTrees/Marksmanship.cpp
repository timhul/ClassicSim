    ...
    spells(static_cast<HunterSpells*>(hunter->get_spells()))
{
    ...
    QMap<QString, Talent*> tier3 {{"3ML", new Talent(hunter, this, "Improved Arcane Shot", "3ML", "Assets/ability/Ability_impalingbolt.png", 5, "Reduces the cooldown of your Arcane Shot by %1 sec.", QVector<QPair<double, double>>{{0.2, 0.2}})},
...
void Marksmanship::add_efficiency(QMap<QString, Talent*>& talent_tier) {
    auto talent = get_new_talent(hunter, "Efficiency", "1MR", "Assets/spell/Spell_frost_wizardmark.png",
...
void Marksmanship::add_improved_hunters_mark(QMap<QString, Talent*>& talent_tier) {
    auto talent = get_new_talent(hunter, "Improved Hunter's Mark", "2ML", "Assets/ability/Ability_hunter_snipershot.png",
...
void Marksmanship::add_lethal_shots(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Lethal Shots", "2MR", "Assets/ability/Ability_searingarrow.png",
...
void Marksmanship::add_aimed_shot(QMap<QString, Talent*>& talent_tier) {
    auto talent = get_new_talent(hunter, "Aimed Shot", "3LL", "Assets/items/Inv_spear_07.png",
...
void Marksmanship::add_mortal_shots(QMap<QString, Talent*>& talent_tier) {
    auto talent = get_new_talent(hunter, "Mortal Shots", "4MR", "Assets/ability/Ability_piercedamage.png",
...
void Marksmanship::add_barrage(QMap<QString, Talent*>& talent_tier) {
    auto talent = get_new_talent(hunter, "Barrage", "5ML", "Assets/ability/Ability_upgrademoonglaive.png",
...
void Marksmanship::add_ranged_weapon_specialization(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Ranged Weapon Specialization", "6MR", "Assets/items/Inv_weapon_rifle_06.png",
