    ...
    spells(static_cast<HunterSpells*>(hunter->get_spells()))
{
    talent_names_to_locations = {
        {"Monster Slaying", "1LL"},
        {"Humanoid Slaying", "1ML"},
        {"Deflection", "1MR"},
        {"Entrapment", "2LL"},
        {"Savage Strikes", "2ML"},
        {"Improved Wing Clip", "2MR"},
        {"Clever Traps", "3LL"},
        {"Survivalist", "3ML"},
        {"Deterrence", "3MR"},
        {"Trap Mastery", "4LL"},
        {"Surefooted", "4ML"},
        {"Improved Feign Death", "4RR"},
        {"Killer Instinct", "5ML"},
        {"Counterattack", "5MR"},
        {"Lightning Reflexes", "6MR"},
        {"Wyvern Sting", "7ML"},
    };

    QMap<QString, Talent*> tier1 {{"1MR", new Talent(pchar, this, "Deflection", "1MR", "Assets/ability/Ability_parry.png", 5, "Increases your Parry chance by %1%.", QVector<QPair<unsigned, unsigned>>{{1, 1}})}};
...
void Survival::add_monster_slaying(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Monster Slaying", "1LL", "Assets/items/Inv_misc_head_dragon_black.png",
...
void Survival::add_humanoid_slaying(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Humanoid Slaying", "1ML", "Assets/spell/Spell_holy_prayerofhealing.png",
...
void Survival::add_surefooted(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Surefooted", "4ML", "Assets/ability/Ability_kick.png",
...
void Survival::add_killer_instinct(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Killer Instinct", "5ML", "Assets/spell/Spell_holy_blessingofstamina.png",
...
void Survival::add_lightning_reflexes(QMap<QString, Talent*>& talent_tier) {
    auto talent = new TalentStatIncrease(hunter, this, "Lightning Reflexes", "6MR", "Assets/spell/Spell_nature_invisibility.png",
