    ...
    spells(static_cast<PaladinSpells*>(paladin->get_spells()))
{
    ...
    QMap<QString, Talent*> tier2 {{"2MR", new Talent(paladin, this, "Deflection", "2MR", "Assets/ability/Ability_parry.png", 5, "Increases your Parry chance by %1%", QVector<QPair<unsigned, unsigned>>{{1, 1}})}};
...
void Retribution::add_benediction(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(paladin, "Benediction", "1MR", "Assets/spell/Spell_frost_windwalkon.png",
...
void Retribution::add_improved_judgement(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(paladin, "Improved Judgement", "2LL", "Assets/spell/Spell_holy_righteousfury.png",
...
void Retribution::add_conviction(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = new TalentStatIncrease(paladin, this, "Conviction", "3ML", "Assets/spell/Spell_holy_retributionaura.png",
...
void Retribution::add_seal_of_command(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(paladin, "Seal of Command", "3MR", "Assets/ability/Ability_warrior_innerrage.png",
...
void Retribution::add_two_handed_weapon_specialization(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = new TalentStatIncrease(paladin, this, "Two-Handed Weapon Specialization", "5LL", "Assets/items/Inv_hammer_04.png",
...
void Retribution::add_sanctity_aura(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(paladin, "Sanctity Aura", "5MR", "Assets/spell/Spell_holy_mindvision.png",
...
void Retribution::add_vengeance(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(paladin, "Vengeance", "6ML", "Assets/ability/Ability_racial_avatar.png",
