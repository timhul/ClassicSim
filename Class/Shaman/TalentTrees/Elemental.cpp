    ...
    spells(dynamic_cast<ShamanSpells*>(shaman->get_spells()))
{
    talent_names_to_locations = {
        ...
        {"Concussion", "1MR"},
        {"Earth's Grasp", "2LL"},
        {"Elemental Warding", "2ML"},
        {"Call of Flame", "2MR"},
        {"Elemental Focus", "3LL"},
        {"Reverberation", "3ML"},
        {"Call of Thunder", "3MR"},
        {"Improved Fire Totems", "4LL"},
        {"Eye of the Storm", "4ML"},
        {"Elemental Devastation", "4RR"},
        {"Storm Reach", "5LL"},
        {"Elemental Fury", "5ML"},
        {"Lightning Mastery", "6MR"},
        {"Elemental Mastery", "7ML"},
    };
    ...
    QMap<QString, Talent*> tier3 {{"3ML", new Talent(shaman, this, "Reverberation", "3ML", "Assets/spell/Spell_frost_frostward.png", 5, "Reduces the cooldown of your Shock spells by %1 sec.", QVector<QPair<double, double>>{{0.2, 0.2}})}};
...
void Elemental::add_elemental_devastation(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(shaman, "Elemental Devastation", "4RR", "Assets/spell/Spell_fire_elementaldevastation.png", 3,
                          ...
                          {},
                          {spells->get_elemental_devastation()});
