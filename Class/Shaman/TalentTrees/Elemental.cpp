...
Talent* Elemental::get_elemental_devastation() {
    return get_new_talent(shaman, "Elemental Devastation", "4RR", "Assets/spell/Spell_fire_elementaldevastation.png", 3,
