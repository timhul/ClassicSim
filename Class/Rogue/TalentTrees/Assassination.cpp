...
Assassination::Assassination(Rogue* pchar) :
    TalentTree("Assassination", "Assets/rogue/rogue_assassination.jpg"), rogue(pchar), spells(static_cast<RogueSpells*>(pchar->get_spells())) {
    ...
    QMap<QString, Talent*> tier1 {{"1ML", new Talent(pchar, this, "Remorseless Attacks", "1ML", "Assets/ability/Ability_fiegndead.png", 2,
                                                     "After killing an opponent that yields experience or honor, gives you a %1 increased critical "
    ...
    QMap<QString, Talent*> tier3 {
        {"3ML", new Talent(pchar, this, "Improved Expose Armor", "3ML", "Assets/ability/Ability_warrior_riposte.png", 2,
                           "Increases the armor reduced by your Expose Armor ability by %1%.", QVector<QPair<unsigned, unsigned>> {{25, 25}})}};
    ...
    QMap<QString, Talent*> tier5 {
        {"5ML",
         new Talent(pchar, this, "Cold Blood", "5ML", "Assets/spell/Spell_ice_lament.png", 1,
        ...
        {"5MR", new Talent(pchar, this, "Improved Kidney Shot", "5MR", "Assets/ability/Ability_rogue_kidneyshot.png", 3,
                           "While affected by your Kidney Shot ability, the target receives an additional %1% damage from all sources.",
...
void Assassination::add_improved_eviscerate(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Improved Eviscerate", "1LL", "Assets/ability/Ability_rogue_eviscerate.png", 3, rank_descriptions,
...
void Assassination::add_ruthlessness(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Ruthlessness", "2LL", "Assets/ability/Ability_druid_disembowel.png", 3, rank_descriptions, {}, {},
...
void Assassination::add_improved_slice_and_dice(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Improved Slice And Dice", "2RR", "Assets/ability/Ability_rogue_slicedice.png", 3, rank_descriptions,
...
void Assassination::add_relentless_strikes(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Relentless Strikes", "3LL", "Assets/ability/Ability_warrior_decisivestrike.png", 1, rank_descriptions,
...
void Assassination::add_lethality(QMap<QString, Talent*>& talent_tier) {
    QMap<unsigned, QString> rank_descriptions;
    QString base_str
        = "Increases the critical strike damage bonus of your Sinister Strike, Gouge, Backstab, Ghostly Strike, and Hemorrhage abilities by %1%.";
    Talent::initialize_rank_descriptions(rank_descriptions, base_str, 5, QVector<QPair<unsigned, unsigned>> {{6, 6}});
    Talent* talent = new Talent(rogue, this, "Lethality", "3MR", "Assets/ability/Ability_criticalstrike.png", 5, rank_descriptions,
...
void Assassination::add_vile_poisons(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Vile Poisons", "4ML", "Assets/ability/Ability_rogue_feigndeath.png", 5, rank_descriptions, {}, {},
...
void Assassination::add_improved_poisons(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Improved Poisons", "4MR", "Assets/ability/Ability_poisons.png", 5, rank_descriptions, {}, {},
                                QVector<Proc*> {rogue->get_mh_instant_poison(), rogue->get_oh_instant_poison()});
...
void Assassination::add_seal_fate(QMap<QString, Talent*>& talent_tier) {
    ...
    Talent* talent = new Talent(rogue, this, "Seal Fate", "6ML", "Assets/spell/Spell_shadow_chilltouch.png", 5, rank_descriptions, {}, {},
