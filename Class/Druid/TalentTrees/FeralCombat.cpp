...
FeralCombat::FeralCombat(Druid* druid) :
    TalentTree("Feral Combat", "Assets/druid/druid_feral.jpg"), druid(druid), spells(static_cast<DruidSpells*>(druid->get_spells())) {
    talent_names_to_locations = {
        {"Ferocity", "1ML"},       {"Feral Aggression", "1MR"},    {"Feral Instinct", "2LL"},    {"Brutal Impact", "2ML"},
        {"Thick Hide", "2MR"},     {"Feline Swiftness", "3LL"},    {"Feral Charge", "3ML"},      {"Sharpened Claws", "3MR"},
        {"Improved Shred", "4LL"}, {"Predatory Strikes", "4ML"},   {"Blood Frenzy", "4MR"},      {"Primal Fury", "4RR"},
    ...
    QMap<QString, Talent*> tier3 {
        {"3LL",
         new Talent(druid, this, "Feline Swiftness", "3LL", "Assets/spell/Spell_nature_spiritwolf.png", 2,
                    "Increases your movement speed by %1% while outdoors in Cat Form and increases your chance to dodge while in Cat Form by %2%.",
                    QVector<QPair<unsigned, unsigned>> {{15, 15}, {2, 2}})},
        {"3ML", new Talent(druid, this, "Feral Charge", "3ML", "Assets/ability/Ability_hunter_pet_bear.png", 1,
...
void FeralCombat::add_improved_shred(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(druid, "Improved Shred", "4LL", "Assets/spell/Spell_shadow_vampiricaura.png", 2,
                                    "Reduces the Energy cost of your Shred ability by %1.", QVector<QPair<unsigned, unsigned>> {{6, 6}},
...
void FeralCombat::add_blood_frenzy(QMap<QString, Talent*>& talent_tier) {
    Talent* talent
        = get_new_talent(druid, "Blood Frenzy", "4MR", "Assets/ability/Ability_ghoulfrenzy.png", 2,
