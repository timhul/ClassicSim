...
Balance::Balance(Druid* druid) :
    TalentTree("Balance", "Assets/druid/druid_balance.jpg"), druid(druid), spells(static_cast<DruidSpells*>(druid->get_spells())) {
    ...
    QMap<QString, Talent*> tier1 {
        {"1ML", new Talent(druid, this, "Nature's Grasp", "1ML", "Assets/spell/Spell_nature_natureswrath.png", 1,
    ...
    QMap<QString, Talent*> tier2 {
        {"2LL", new Talent(druid, this, "Improved Entangling Roots", "2LL", "Assets/spell/Spell_nature_stranglevines.png", 3,
                           "Gives you a %1% chance to avoid interruption caused by damage while casting Entangling Roots.",
    ...
    QMap<QString, Talent*> tier3 {
        {"3LL", new Talent(druid, this, "Improved Thorns", "3LL", "Assets/spell/Spell_nature_thorns.png", 3,
                           "Increases damage caused by your Thorns spell by %1%.", QVector<QPair<unsigned, unsigned>> {{25, 25}})},
        {"3RR", new Talent(druid, this, "Nature's Reach", "3RR", "Assets/items/Inv_misc_branch_01.png", 2,
                           "Increases the range of your Wrath, Entangling Roots, Faerie Fire, Moonfire, Starfire, and Hurricane spells by %1%.",
...
void Balance::add_improved_wrath(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(druid, "Improved Wrath", "1LL", "Assets/items/Spell_nature_abolishmagic.png", 5,
                                    "Reduces the cast time of your Wrath spell by 0.%1 sec.", QVector<QPair<unsigned, unsigned>> {{1, 1}},
...
void Balance::add_improved_natures_grasp(QMap<QString, Talent*>& talent_tier) {
    ...
    QMap<unsigned, QString> rank_descriptions {{0, base_str.arg(15)},
                                               ...
                                               {3, base_str.arg(45)},
                                               {4, base_str.arg(65)}};
    Talent* talent = new Talent(druid, this, "Improved Nature's Grasp", "1MR", "Assets/spell/Spell_nature_natureswrath.png", 4, rank_descriptions);
...
void Balance::add_natural_shapeshifter(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(druid, "Natural Shapeshifter", "2RR", "Assets/spell/Spell_nature_wispsplode.png", 3,
                                    "Reduces the mana cost of all shapeshifting by %1%.", QVector<QPair<unsigned, unsigned>> {{10, 10}},
...
void Balance::add_omen_of_clarity(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(druid, "Omen of Clarity", "3MR", "Assets/items/Inv_misc_orb_01.png", 1,
                                    "Imbues the Druid with natural energy. Each of the Druid's melee attacks has a chance of causing the caster to "
...
void Balance::add_natures_grace(QMap<QString, Talent*>& talent_tier) {
    Talent* talent
        = get_new_talent(druid, "Nature's Grace", "5ML", "Assets/spell/Spell_nature_naturesblessing.png", 1,
...
void Balance::add_moonglow(QMap<QString, Talent*>& talent_tier) {
    Talent* talent
        = get_new_talent(druid, "Moonglow", "5MR", "Assets/spell/Spell_nature_sentinal.png", 3,
...
void Balance::add_moonkin_form(QMap<QString, Talent*>& talent_tier) {
    Talent* talent
        = get_new_talent(druid, "Moonkin Form", "7ML", "Assets/spell/Spell_nature_forceofnature.png", 1,
                         "Transforms the Druid into Moonkin Form.  While in this form the armor contribution from items is increased by 360% and "
