...
Arcane::Arcane(Mage* mage) : TalentTree("Arcane", "Assets/mage/mage_arcane.jpg"), mage(mage), spells(static_cast<MageSpells*>(mage->get_spells())) {
    talent_names_to_locations = {
        {"Arcane Subtlety", "1LL"},   {"Arcane Focus", "1ML"},         {"Improved Arcane Missiles", "1MR"}, {"Wand Specialization", "2LL"},
        {"Magic Absorption", "2ML"},  {"Arcane Concentration", "2MR"}, {"Magic Attunement", "3LL"},         {"Improved Arcane Explosion", "3ML"},
        {"Arcane Resilience", "3MR"}, {"Improved Mana Shield", "4LL"}, {"Improved Counterspell", "4ML"},    {"Arcane Meditation", "4RR"},
        {"Presence of Mind", "5ML"},  {"Arcane Mind", "5MR"},          {"Arcane Instability", "6ML"},       {"Arcane Power", "7ML"},
    };

    QMap<QString, Talent*> tier1 {
        {"1MR", new Talent(mage, this, "Improved Arcane Missiles", "1MR", "Assets/spell/Spell_nature_starfall.png", 5,
                           "Gives you a %1% chance to avoid interruption caused by damage while channeling Arcane Missiles.",
    ...
    QMap<QString, Talent*> tier2 {
        {"2LL", new Talent(mage, this, "Wand Specialization", "2LL", "Assets/items/Inv_wand_01.png", 2, "Increases your damage with Wands by %1%.",
                           QVector<QPair<unsigned, unsigned>> {{13, 12}})},
        {"2ML",
         new Talent(mage, this, "Magic Absorption", "2ML", "Assets/spell/Spell_nature_astralrecalgroup.png", 5,
                    "Increases all resistances by %1 and causes all spells you fully resist to restore %2% of your total mana. 1 sec. cooldown.",
                    QVector<QPair<unsigned, unsigned>> {{2, 2}, {1, 1}})}};
    add_arcane_concentration(tier2);
    add_talents(tier2);

    QMap<QString, Talent*> tier3 {{"3LL", new Talent(mage, this, "Magic Attunement", "3LL", "Assets/items/Spell_nature_abolishmagic.png", 2,
                                                     "Increases the effect of your Amplify Magic and Dampen Magic spells by %1%.",
                                                     QVector<QPair<unsigned, unsigned>> {{25, 25}})},
                                  {"3ML", new Talent(mage, this, "Improved Arcane Explosion", "3ML", "Assets/spell/Spell_nature_wispsplode.png", 3,
                                                     "Increases the critical strike chance of your Arcane Explosion spell by an additional %1%.",
                                                     QVector<QPair<unsigned, unsigned>> {{2, 2}})},
                                  {"3MR", new Talent(mage, this, "Arcane Resilience", "3MR", "Assets/spell/Spell_arcane_arcaneresilience.png", 1,
                                                     "Increases your armor by an amount equal to 50% of your Intellect.",
                                                     QVector<QPair<unsigned, unsigned>> {})}};
    add_talents(tier3);

    QMap<QString, Talent*> tier4 {{"4LL",
                                   new Talent(mage, this, "Improved Mana Shield", "4LL", "Assets/spell/Spell_shadow_detectlesserinvisibility.png", 2,
                                              "Decreases the mana lost per point of damage taken when Mana Shield is active by %1%.",
                                              QVector<QPair<unsigned, unsigned>> {{10, 10}})},
                                  {"4ML", new Talent(mage, this, "Improved Counterspell", "4ML", "Assets/spell/Spell_frost_iceshock.png", 2,
                                                     "Gives your Counterspell a %1% chance to silence the target for 4 sec.",
                                                     QVector<QPair<unsigned, unsigned>> {{50, 50}})}};
    add_arcane_meditation(tier4);
    add_talents(tier4);

    QMap<QString, Talent*> tier5 {
        {"5ML", new Talent(mage, this, "Presence of Mind", "5ML", "Assets/spell/Spell_nature_enchantarmor.png", 1,
...
void Arcane::add_arcane_subtlety(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = new TalentStatIncrease(
        mage, this, "Arcane Subtlety", "1LL", "Assets/spell/Spell_holy_dispelmagic.png", 2,
...
void Arcane::add_arcane_concentration(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = get_new_talent(mage, "Arcane Concentration", "2MR", "Assets/spell/Spell_shadow_manaburn.png", 5,
                                    "Gives you a %1% chance of entering a Clearcasting state after any damage spell hits a target. The Clearcasting "
...
void Arcane::add_arcane_mind(QMap<QString, Talent*>& talent_tier) {
    Talent* talent = new TalentStatIncrease(mage, this, "Arcane Mind", "5MR", "Assets/spell/Spell_shadow_charm.png", 5,
                                            "Increases your maximum Mana by %1%.", QVector<QPair<unsigned, unsigned>> {{2, 2}},
