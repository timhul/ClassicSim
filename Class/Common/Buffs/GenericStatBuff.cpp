...
GenericStatBuff::GenericStatBuff(
    Character* pchar, const QString& name, const QString& icon, const int duration, const QVector<QPair<ItemStats, unsigned>>& stat_type_values_) :
    SelfBuff(pchar, name, icon, duration, 0), stat_type_values(stat_type_values_) {}
